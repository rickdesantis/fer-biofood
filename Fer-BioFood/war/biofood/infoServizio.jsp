...
<div id="sidebar">
   	  <div class="padding">
      	<ul id="structLink" >
            ...
            <li ><a href="modulo">Modulo acquisti</a></li>
    	</ul>
      </div>
  </div>
  <div id="content">
  ...
  <img id= "toprightimage" src="images/cc-carne.gif" width="256" height="200" alt="carnazza" />
	<div class="padding"><h2>Come acquistare</h2>
	  <p>Per acquistare da noi ci mandate i soldi, poi noi forse vi mandiamo la roba.</p>
</div>
  </div>
  <div id="footer"></div>
</div>
